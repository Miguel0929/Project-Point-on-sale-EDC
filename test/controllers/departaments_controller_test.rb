...
class DepartamentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create departament" do
    assert_difference('Departament.count') do
      post departaments_url, params: { departament: { strDepartament: @departament.strDepartament } }
    end
  ...
  test "should update departament" do
    patch departament_url(@departament), params: { departament: { strDepartament: @departament.strDepartament } }
