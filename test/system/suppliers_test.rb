...
class SuppliersTest < ApplicationSystemTestCase
  ...
  test "creating a Supplier" do
    ...
    fill_in "Strcelular", with: @supplier.strCelular
    fill_in "Strdireccion", with: @supplier.strDireccion
    fill_in "Strnombreproveedor", with: @supplier.strNombreProveedor
    fill_in "Strtelefono", with: @supplier.strTelefono
